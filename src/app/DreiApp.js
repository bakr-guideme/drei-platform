...
const QUIZZES = {
  ...
  201: [
    { q: "A crew has been working hard on power. Erg scores are up, but on the water they seem slower and more fatigued. Using Drew's framework, what's the most likely problem?", opts: ["Need more fitness training", "Rigging needs adjustment", "They're producing power with tension rather than relaxation — go back to ensuring correct sequence and length before layering power back on", "Water conditions changed", "Should rate higher"], ans: 2 },
    { q: "A rower tells you: 'My forearms are really pumped and my shoulders are aching.' Based on Drew's teaching, what does this indicate?", opts: ["Excellent workout targeting right muscles", "Gripping too hard and producing power through upper body rather than legs — power is in the wrong place", "Normal fatigue", "Need stronger forearms", "Oar handles too thick"], ans: 1 },
    ...
    { q: "Your crew has poor run at rate 28 and asks to go to 32 for more speed. Based on Drew's rhythm concepts, what should you do?", opts: ["Let them try 32", "Drop to 22-24 to establish rhythm and boat run, build rate back up only when rhythm is maintained", "Keep 28 but pull harder", "Focus on catch timing", "Switch boats"], ans: 1 },
    { q: "Drew says hands off the finish should 'move with the speed of the boat.' An athlete's hands fly away much faster than the boat. What consequences would you expect?", opts: ["Faster boat speed", "Athlete arrives at catch too early, has to wait creating tension, soft knee break is lost, boat decelerates as body weight rushes forward faster than the hull", "No consequences", "Better catch preparation", "Only feathering affected"], ans: 1 },
  ],
  202: [
    { q: "A sweep rower has excellent sequence but looks mechanical and can't generate power at the catch without tension. What's most likely missing?", opts: ["Need to pull harder", "Rate higher", "Sequence is right but robotic — need to feel blend and flow, letting outside hand lead continuously from inside hip to catch, storing elasticity", "Erg fitness insufficient", "Rigging wrong"], ans: 2 },
    { q: "Drew compares sweep power production to which other sports, and why?", opts: ["Swimming and cycling — same muscles", "Golf and tennis — rotational activities where power comes from body rotation, not arm strength", "Running and jumping — leg drive", "Weightlifting — maximum force", "Boxing — quick hands"], ans: 1 },
